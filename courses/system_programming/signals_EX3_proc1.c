 ...
 * Description: Ping-Pong exercise without fork (using sig_info)- Pong process
 *****************************************************************************/
...
int main(int argc, char *argv[])
{
	...
	{
		/* The mate's PID comes with the execution arguments.
			It comes as a string and need to be translated 	  */
		if (0 == kill(atoi(argv[1]), SIGUSR2)) 	
		{
			if (argc > 1)
			{
				status = EXIT_SUCCESS;
